...
const isOptimized =
  typeof argValues.optimize !== 'undefined' && argValues.optimize;

const templateFormats =
  typeof argValues.template !== 'undefined'
    ? argValues.template.split(',')
    : null;

const cssTemplatePath =
  typeof argValues.csspath === 'undefined' ? null : argValues.csspath;

const jsTemplatePath =
  typeof argValues.jspath === 'undefined' ? null : argValues.jspath;

const cssPrefix =
  typeof argValues.cssprefix === 'undefined' ? null : argValues.cssprefix;

const jsPrefix =
  typeof argValues.jsprefix === 'undefined' ? null : argValues.jsprefix;

const licensePath =
  typeof argValues.license === 'undefined' ? null : argValues.license;

const jpgScale =
  typeof argValues.jpgscale === 'undefined' ? null : argValues.jpgscale;

const pngScale =
  typeof argValues.pngscale === 'undefined' ? null : argValues.pngscale;

const propertiesFilters =
  typeof argValues.filter !== 'undefined'
    ? argValues.filter.replace(/\s/g, '').split(',')
    : null;

const isPropNames =
  typeof argValues.propnames !== 'undefined' && argValues.propnames;
...
const main = async () => {
  ...
  let iconNodeData = figmaApiHandler.parseFileData(
    figmaData,
    propertiesFilters,
    isPropNames
  );
